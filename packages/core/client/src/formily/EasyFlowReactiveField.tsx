 ...
 */
const EasyFlowReactiveInternal: React.FC<IReactiveFieldProps> = (props) => {
...
EasyFlowReactiveInternal.displayName = 'EasyFlowReactiveInternal';

/**
 * Based on @formily/react v2.3.2 EasyFlowReactiveField component
 * Modified to better adapt to EasyFlow's needs
 */
export const EasyFlowReactiveField = EasyFlowReactiveInternal;

EasyFlowReactiveField.displayName = 'EasyFlowReactiveField';
