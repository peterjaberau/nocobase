...
export function createEasyFlowField<Decorator extends JSXComponent, Component extends JSXComponent>(props: any) {
  return new EasyFlowField(props);
}

/**
 * Compared to the Field class, EasyFlowField has better performance
 */
class EasyFlowField<
