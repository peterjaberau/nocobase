...
import { FormItem, Input, SchemaComponent, useApp } from '@easyflow/client';
            ...
            advanced: {
              ...
              properties: {
                ...
                http: {
                  ...
                  'x-decorator': 'FormItem',
                  'x-decorator-props': {
                    tooltip: '{{t("Check if EasyFlow is running on HTTP protocol")}}',
                  },
                },
                port: {
                  type: 'number',
                  ...
                  'x-decorator': 'FormItem',
                  'x-decorator-props': {
                    tooltip: '{{t("The port number of the EasyFlow service if it is not 80 or 443")}}',
                  },
                  'x-component-props': {
                    style: {
                      width: '15%',
