import { ActionContent, ActionType, BaseAiAgentActionContent } from '../../../public-types/action';
...
export function getInitialAgentContent(agent: any): BaseAiAgentActionContent {
  return {
