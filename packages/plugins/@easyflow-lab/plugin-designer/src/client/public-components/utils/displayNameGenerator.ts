export default class DisplayNameGenerator {
  ...
  public generateDisplayName = (prefix: string, callback?: (newDisplayName: string) => void) => {
    let index = 1;
  ...
  public removeMultiDisplayName = (displayNames: string[], callback?: (displayName: string[]) => void) => {
  ...
  public updateOrGenerateDisplayName = (displayName: string, addCallback?: (displayName: string) => void) => {
