export enum ERROR_FLAG {
  ...
  // colla pay error
  ERROR_FLAG_INSUFFICIENT_COLLA = 'ERROR_FLAG_INSUFFICIENT_COLLA',
  ...
  ERROR_FLAG_AUTO_CHARGE_COLLA_FAILED = 'ERROR_FLAG_AUTO_CHARGE_COLLA_FAILED',
  ERROR_FLAG_COLLA_PAYMENT_FAILURE = 'ERROR_FLAG_COLLA_PAYMENT_FAILURE',
  ERROR_FLAG_AI_AGENT_MAX_TOKEN_OVER_COLLA_BALANCE = 'ERROR_FLAG_AI_AGENT_MAX_TOKEN_OVER_COLLA_BALANCE',
}
