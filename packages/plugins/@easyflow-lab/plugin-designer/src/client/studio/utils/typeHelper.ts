...
import { isString, isObject } from './system/is';
...
export const isDriveActionContent = (
  ...
  return (
    ...
    Object.values(ILLA_DRIVE_ACTION_REQUEST_TYPE).includes(actionContent.operation as ILLA_DRIVE_ACTION_REQUEST_TYPE)
  );
};
