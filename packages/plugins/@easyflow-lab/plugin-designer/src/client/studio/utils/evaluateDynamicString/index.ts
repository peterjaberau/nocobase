import { hasDynamicStringSnippet } from '../../../public-components/dynamic-string-utils';
...
export const evaluateDynamicString = (keyInDataTree: string, dynamicString: string, dataTree: Record<string, any>) => {
