 ...
 */
export const getInitialsAndColorCode = (fullName: string | undefined, wordTail?: boolean): string[] => {
  if (!fullName) {
    return [''];
  }
  let inits = '';
...
export const getNextEntityName = (prefix: string, existingNames: string[], startWithoutIndex?: boolean) => {
