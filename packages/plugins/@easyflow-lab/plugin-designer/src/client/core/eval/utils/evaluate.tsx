...
export function filterDepends(unevaledValue: string, exposingNodes: Record<string, Node<unknown>>, maxDepth?: number) {
...
export function changeDependName(unevaledValue: string, oldName: string, name: string, isFunction?: boolean) {
...
function parseDepends(jsSnippet: string, exposingNodes: Record<string, Node<unknown>>, maxDepth?: number) {
...
function getDependNode(
  ...
  for (const subPath of subPaths) {
    ...
    if (!Object.prototype.hasOwnProperty.call(nodes, subPath) || !subNode) {
      break;
    }
    node = subNode;
    path.push(subPath);
