...
import { AbstractComp, Comp, CompParams, ConstructorToDataType, DispatchType, OptionalNodeType } from './comp';

/**
 * MultiBaseCompConstructor with abstract function implemented
 */
export type MultiCompConstructor = new (params: CompParams<any>) => MultiBaseComp<any, any, any> & Comp<any, any, any>;
...
> extends AbstractComp<any, DataType, NodeType> {
    ...
    switch (action.type) {
      case CompActionTypes.MULTI_CHANGE: {
        ...
        let mcChildren = _.omitBy(this.children, (comp, childName) => {
          ...
          return innerAction && innerAction.type === CompActionTypes.DELETE_COMP && innerAction.path.length === 0;
        });
        // CHANGE
  ...
  protected setChildren(children: Record<string, Comp>, params?: { keepCacheKeys?: string[] }): this {
  ...
  override toJsonValue(): DataType {
    ...
    Object.keys(this.children).forEach((key) => {
      ...
      if (Object.prototype.hasOwnProperty.call(comp, 'NO_PERSISTENCE')) {
        return;
      }
