...
import { useToken } from '@easyflow/client';
...
const AppShell = ({ children, header }: { children?: ReactNode; header?: ReactNode }) => {
  ...
  const sidebarLeftActorRef = snapshot.context.draggablePanels.find((panel) => panel.id === 'panel-sidebarLeft');
  const sidebarRightActorRef = snapshot.context.draggablePanels.find((panel) => panel.id === 'panel-sidebarRight');
  const bottomPanelActorRef = snapshot.context.draggablePanels.find((panel) => panel.id === 'panel-bottomPanel');
